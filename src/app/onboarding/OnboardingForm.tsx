...
export default function OnboardingForm() {
    ...
    const handleSubmit = async (formData: FormData) => {
        ...
        if (chest) formData.set("chest", chest);
        if (leg) formData.set("leg", leg);
        if (arm) formData.set("arm", arm);
        if (lifestyle) formData.set("lifestyle", lifestyle);
                    ...
                    {step === 1 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="grid gap-4">
                                ...
                                <button type="button" disabled className="flex flex-col text-left p-6 rounded-xl border-2 border-slate-800 bg-slate-900/30 opacity-60 cursor-not-allowed relative overflow-hidden">
                    ...
                    {step === 2 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="flex gap-3">
                                <button type="button" onClick={handleBack} className="w-1/3 h-12 rounded-md border border-slate-700 font-semibold text-slate-300 hover:bg-slate-800 transition-colors">Back</button>
                                <button
                                    type="button"
                                    onClick={handleNext}
                    ...
                    {step === 3 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="flex gap-3 pt-4">
                                <button type="button" onClick={handleBack} disabled={isSubmitting} className="w-1/3 h-12 rounded-md border border-slate-700 font-semibold text-slate-300 hover:bg-slate-800 transition-colors">Back</button>
                                <button
                                    type="submit"
